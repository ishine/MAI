...
class VTBLTest : public NeonTest {
};

TEST_F(VTBLTest, VTBL1) {
    int8x8_t a = {1, 5, 4, 0, 7, 2, 4, 3};
    int8x8_t b = {0, 4, 7, 1, 5, 5, 3, 2};
    int8x8_t rr = vtbl1_s8(a, b);
    printNeonVector(rr);
}

TEST_F(VTBLTest, VTBL2) {
    int8x8x2_t a = {0,1,2,3,4,5,6,7,
                    93,94,95,96,97,98,99,100};
    int8x8_t b = {15, 0, 10, 8, 3, 6, 5, 7};
    int8x8_t rr = vtbl2_s8(a, b);
    printNeonVector(rr);
}

TEST_F(VTBLTest, VTBL3) {
